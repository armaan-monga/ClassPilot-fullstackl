          ...
          <div className="divide-y divide-ink/5">
            {students.map((s) => (
              <Link
                key={s._id}
                to={`/students/${s._id}`}
                className="flex items-center gap-3 px-5 py-3 hover:bg-iris-50/40"
              >
                <div className="flex h-9 w-9 items-center justify-center rounded-full bg-iris-500 text-xs font-bold text-white">
                  {initials(s.fullName)}
                </div>
