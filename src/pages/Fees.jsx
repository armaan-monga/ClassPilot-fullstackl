        ...
        <Card className="!p-0 overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {fees.map((f) => (
                  <tr key={f._id} className="border-b border-ink/5 last:border-0 hover:bg-petrol-50/40">
                    <td className="px-5 py-3">
                      <Link to={`/students/${f.student?._id}`} className="font-semibold text-ink hover:text-petrol-600">
                        {f.student?.fullName}
                      </Link>
                    </td>
                    <td className="px-5 py-3">
                    ...
                    <td className="px-5 py-3 text-right">
                      {f.status === "Paid" ? (
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-1 rounded-xl bg-petrol-50 px-3 py-1.5 text-xs font-semibold text-petrol-600 hover:bg-petrol-100"
                        >
