        ...
        <Card className="!p-0 overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {students.map((s) => (
                  <tr key={s._id} className="border-b border-ink/5 last:border-0 hover:bg-petrol-50/40">
                    ...
                    <td className="px-5 py-3">
                      <div className="flex items-center justify-end gap-1">
                        <button
                          ...
                          className="rounded-lg p-2 text-ink/40 hover:bg-slate-50 hover:text-slate-600"
                          title="Move batch"
                        >
                        ...
                        <button
                          ...
                          className="rounded-lg p-2 text-ink/40 hover:bg-petrol-50 hover:text-petrol-600"
                          title="Edit"
                        >
                          <Pencil size={15} />
                        </button>
                        <button
                          ...
                          className="rounded-lg p-2 text-ink/40 hover:bg-oxblood-50 hover:text-oxblood-600"
                          title="Delete"
                        >
                          <Trash2 size={15} />
                        </button>
              ...
              {Array.from({ length: pagination.pages }, (_, i) => i + 1).map((p) => (
                <button
                  ...
                  className={`h-8 w-8 rounded-full text-xs font-semibold ${
                    p === pagination.page ? "bg-petrol-500 text-white" : "text-ink/50 hover:bg-ink/5"
                  }`}
                >
                  {p}
                </button>
