    ...
    <div className="flex flex-col gap-5">
      ...
      <Card className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-4">
          <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-3xl bg-petrol-500 text-xl font-bold text-white">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <Card>
          ...
          <div className="mt-4 border-t border-ink/5 pt-4">
            <p className="text-xs font-semibold text-ink/50">Parent</p>
            <p className="mt-1 text-sm font-medium text-ink">{student.parentName || "—"}</p>
            <p className="text-sm text-ink/60">{student.parentPhone || "—"}</p>
            <p className="text-sm text-ink/60">{student.parentEmail || student.email || "No email on file"}</p>
          </div>
        </Card>

        <Card className="flex flex-col items-center justify-center text-center">
          <p className="mb-2 flex items-center gap-1.5 text-xs font-bold text-ink/50">
            <CalendarCheck2 size={13} /> Attendance
          </p>
          <div className="relative flex h-28 w-28 items-center justify-center">
            <svg className="h-full w-full -rotate-90">
              <circle cx="56" cy="56" r="46" stroke="#E6E1D2" strokeWidth="11" fill="none" />
              <circle
                cx="56" cy="56" r="46" stroke="#5C8A55" strokeWidth="11" fill="none"
        ...
        <Card>
          ...
          <div className="mt-3 flex gap-2 text-xs">
            ...
            <span className="pill bg-ochre-100 text-ochre-700">
