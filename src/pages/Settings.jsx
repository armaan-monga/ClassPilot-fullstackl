      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
        <Card>
          <h3 className="mb-4 flex items-center gap-2 font-display text-base font-bold text-ink">
            <Building2 size={17} className="text-iris-500" /> Institute Details
          </h3>
        ...
        <Card>
          <h3 className="mb-4 flex items-center gap-2 font-display text-base font-bold text-ink">
            <User size={17} className="text-iris-500" /> Teacher Profile
          </h3>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <Card>
          <h3 className="mb-4 flex items-center gap-2 font-display text-base font-bold text-ink">
            <Palette size={17} className="text-iris-500" /> Appearance & Reminders
          </h3>
          <div className="mb-4">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="flex items-end gap-2">
              <label className="flex items-center gap-2 text-sm font-medium text-ink/70">
                <input type="checkbox" {...register("lateFeeEnabled")} className="h-4 w-4 rounded accent-iris-500" />
                Enable Late Fee
              </label>
            </div>
          </div>
