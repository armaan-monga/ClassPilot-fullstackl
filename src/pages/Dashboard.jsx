...
const QUICK_ACTIONS = [
  { to: "/students", label: "Add Student", icon: UserPlus, color: "bg-petrol-500" },
  { to: "/batches", label: "Add Batch", icon: LayersIcon, color: "bg-slate-500" },
  { to: "/attendance", label: "Mark Attendance", icon: ClipboardList, color: "bg-meadow-500" },
  { to: "/notifications", label: "Send Reminders", icon: Bell, color: "bg-ochre-500" },
];
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        <StatCard icon={Users} label="Total Students" value={stats.totalStudents} color="petrol" />
        <StatCard icon={Layers} label="Active Batches" value={stats.activeBatches} color="slate" />
        <StatCard
          icon={AlertCircle}
          label="Pending Fees"
        ...
        <Card className="flex flex-col items-center justify-center text-center">
          ...
          <div className="relative flex h-32 w-32 items-center justify-center">
            <svg className="h-full w-full -rotate-90">
              <circle cx="64" cy="64" r="54" stroke="#E6E1D2" strokeWidth="12" fill="none" />
              <circle
                cx="64" cy="64" r="54" stroke="#5C8A55" strokeWidth="12" fill="none"
