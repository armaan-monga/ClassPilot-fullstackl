...
export default function Register() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-petrol-800 p-4 py-10">
      <div className="w-full max-w-md">
        ...
        <div className="glass-card-solid p-7">
          ...
          <p className="mt-6 text-center text-sm text-ink/55">
            ...
            <Link to="/login" className="font-semibold text-petrol-600 hover:underline">
              Log in
            </Link>
          </p>
        </div>
